...
def block_causal_lact_swiglu(
    ...
    for i in range(0, seq_len - chunk_size, chunk_size):
        ...
        # dvpi = - dL/dv'
        # dvpi = vi # loss = - <v', v>, dL/dv' = -v, dvpi = v.
        dvpi = vi - vpi # loss = 0.5 * ||v' - v||^2, dL/dv' = (v' - v), dvpi = v - v'.
        ...
        # it's better to cast the mat to bf16 before bmm.
        dw1 = torch.bmm(dvpi, (hidden.transpose(1, 2) * lr1i).type_as(dvpi))  # [b, d, d]
