...
class Generator:
    def __init__(self):
        self.model_config = {
            ...
            'lact_l12_d768_ttt1x': 'config/lact_l12_d768_ttt1x.yaml',
        }
    ...
    def generate_script(self, args):
        ...
        script_lines = [
            ...
            f"export OMP_NUM_THREADS={slurm['cpus_per_task']//slurm['gpu_count']}",
...
def main():
    ...
    parser.add_argument('--config', 
                        choices=['lact_l14_d768_ttt2x', 'lact_l24_d768_ttt2x', 'lact_l24_d768_ttt4x', 'lact_l12_d768_ttt2x', 'lact_l18_d768_ttt2x', 'lact_l12_d768_ttt1x'],
